package ru.fidarov.dataUploader.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import ru.fidarov.dataUploader.models.*;
import ru.fidarov.dataUploader.repo.*;
...
public class OperationHistoryDataLoader {
    ...
    @Autowired
    public OperationHistoryDataLoader(
    ...
    public void loadDataFromCSV() {
        ...
        executor.submit(() ->
                loadData(
                        "/home/georgii/Downloads/LogisticCompany/DataLoader/src/main/resources/data/OperationHistory.csv",
        ...
        executor.submit(() ->
                loadData(
                        "/home/georgii/Downloads/LogisticCompany/DataLoader/src/main/resources/data/Product.csv",
                        this::createProduct,
                        productRepository,
                        countDownLatch
                ));
        executor.submit(() ->
                loadData(
                        "/home/georgii/Downloads/LogisticCompany/DataLoader/src/main/resources/data/Price.csv",
                        this::createPrice,
                        priceRepository,
                        countDownLatch
                ));
        executor.submit(() ->
                loadData(
                        "/home/georgii/Downloads/LogisticCompany/DataLoader/src/main/resources/data/Customer.csv",
                        this::createCustomer,
                        customerRepository,
                        countDownLatch
                ));
    ...
    private void calculateAndSavePromo(){
        ...
        for (Object[] row : result) {
            ...
            double percent = Math.abs(100-((calculatedPrice/pricePerOneUnit)*100));
